    ...
    <div className="container-xxl">
        ...
        largeImage: {
          ...
          height: 1300
              ...
              <div><img src={images.tab} className='img-fluid'/></div>
              <div><img src={images.tab2} className='img-fluid'/></div>
              <div><img src={images.tab3} className='img-fluid'/></div>
              <div><img src={images.tab1} className='img-fluid'/></div>
              </div>
            </div>
            ...
            <div className="col-6">
              ...
              <div className="main-product-details">
                <div className="border-bottom">
                  <h3 className='title'>Tablet Bulk 10 Pack Multi Colored For Students</h3>
                </div>
                <div className="border-bottom">
            ...
            />
             <p className='mb-0 rev'>(2 reviews)</p>
                ...
                <div className='main-product-details-content py-4'>
                  <p className='type'>Type: <span >Tablet</span></p>
