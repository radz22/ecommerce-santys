                ...
                <div className="col-12">
                   <div className="single-blog-card">
                    ...
                    <h3 className="title">A Beautiful Sunday Morning Renaissance</h3>
                     <img src="https://www.hostinger.com/tutorials/wp-content/uploads/sites/2/2022/03/what-is-a-blog-1.webp" className='img-fluid w-100 my-4'/>
